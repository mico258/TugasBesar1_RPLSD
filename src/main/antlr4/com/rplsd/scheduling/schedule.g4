...
kelas: WHITESPACE* BRACKET_OPEN NEWLINE* matkul NEWLINE* (WHITESPACE* (requirement|availability|capacity) WHITESPACE* NEWLINE*)* WHITESPACE* BRACKET_CLOSE WHITESPACE* NEWLINE*;
